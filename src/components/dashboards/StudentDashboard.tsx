...
export default function StudentDashboard() {
    ...
    const fetchDashboardData = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/student/dashboard/${student.naturalId}/${student.semesterId}`
        );
  ...
  useEffect(() => {
    const fetchUnreadMessagesCount = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/student/messages/unread-count/${student.naturalId}/${student.semesterId}`
        );
        const data = await res.json();
