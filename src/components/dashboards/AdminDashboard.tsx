...
export default function AdminDashboard() {
 ...
 const fetchSemesters = () => {
  fetch("https://school-portal-backend-new.onrender.com/semesters")
    .then(res => res.json())
    .then(data => {
...
const handleAddSemester = async () => {
  ...
  try {
    const res = await fetch("https://school-portal-backend-new.onrender.com/semesters", {
      method: "POST",
      headers: {
  ...
  try {
    const res = await fetch(`https://school-portal-backend-new.onrender.com/semesters/${editingId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json"
      },
...
const handleDelete = async (id: number) => {
  try {
    const res = await fetch(`https://school-portal-backend-new.onrender.com/semesters/${id}`, {
      method: "DELETE"
    });
