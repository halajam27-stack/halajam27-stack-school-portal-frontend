...
export default function TeacherAttendanceEntry() {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/teacher/students/${sectionId}/${semesterId}`
        );
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchPeriods = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/teacher/attendance/periods?sectionId=${sectionId}&subjectId=${subjectId}&semesterId=${semesterId}&dayOfWeek=${encodeURIComponent(dayOfWeek)}`
        );
  ...
  useEffect(() => {
    const fetchExistingAttendance = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/teacher/attendance/existing?sectionId=${sectionId}&subjectId=${subjectId}&semesterId=${semesterId}&periodId=${selectedPeriodId}&date=${date}`
        );
...
if (data.length > 0) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const url = 'https://school-portal-backend-new-cfr6.onrender.com/teacher/attendance';
