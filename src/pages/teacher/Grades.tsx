...
export default function TeacherGrades() {
  ...
  useEffect(() => {
    const fetchGradeTypes = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new.onrender.com/teacher/grades/types/${semesterId}`
        );
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new.onrender.com/teacher/grades/students/${sectionId}/${semesterId}`
        );
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchExistingGrades = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new.onrender.com/teacher/grades/existing?sectionId=${sectionId}&subjectId=${subjectId}&semesterId=${semesterId}&schemeId=${selectedGradeType}`
        );
        const data = await res.json();
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch('https://school-portal-backend-new.onrender.com/teacher/grades', {
