...
export default function TeacherTasks() {
  ...
  const fetchTasks = async () => {
    ...
    try {
      const res = await fetch(
        `https://school-portal-backend-new.onrender.com/teacher/tasks/${sectionId}/${subjectId}/${semesterId}`
      );
      const data = await res.json();
...
.sort((a, b) => {
  ...
  const handleAddTask = async () => {
    ...
    try {
      const res = await fetch('https://school-portal-backend-new.onrender.com/teacher/tasks', {
        method: 'POST',
        headers: {
  ...
  const handleDeleteTask = async (id: number) => {
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/teacher/tasks/${id}`, {
        method: 'DELETE',
      });
