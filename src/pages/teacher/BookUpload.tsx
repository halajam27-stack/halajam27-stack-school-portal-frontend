...
export default function TeacherBookUpload() {
  ...
  useEffect(() => {
    const fetchCurrentBook = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new.onrender.com/teacher/book/${subjectId}/${semesterId}`
        );
        const data = await res.json();
        ...
        if (data.BookPath) {
          ...
          setUploadedBook({
            ...
            size: 'غير معروف',
            path: `https://school-portal-backend-new.onrender.com${data.BookPath}`,
          });
        } else {
  ...
  const handleFileUpload = async (file: File | null) => {
    ...
    try {
      ...
      const res = await fetch('https://school-portal-backend-new.onrender.com/teacher/book-upload', {
        method: 'POST',
        body: formData,
      });
