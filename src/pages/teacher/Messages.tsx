...
export default function TeacherMessages() {
    ...
    const fetchSubjects = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/teacher/messages/subjects/${teacherId}/${semesterId}`
        );
  ...
  useEffect(() => {
    const fetchUnreadSubjects = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/teacher/messages/unread-subjects/${teacherId}/${semesterId}`
        );
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/teacher/messages/students/${selectedSubjectData.sectionId}/${semesterId}`
        );
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchUnreadStudents = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/teacher/messages/unread-students?sectionId=${selectedSubjectData.sectionId}&subjectId=${selectedSubjectData.subjectId}&semesterId=${semesterId}&teacherId=${teacherId}`
        );
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/teacher/messages/chat?sectionId=${selectedSubjectData.sectionId}&subjectId=${selectedSubjectData.subjectId}&semesterId=${semesterId}&teacherId=${teacherId}&studentId=${selectedStudentId}`
        );
        const data = await res.json();
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const res = await fetch('https://school-portal-backend-new-cfr6.onrender.com/teacher/messages/send', {
        method: 'POST',
...
const handleEditMessage = async (id: number, newText: string) => {
  try {
    const res = await fetch(`https://school-portal-backend-new-cfr6.onrender.com/messages/${id}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        senderId: teacherId,
