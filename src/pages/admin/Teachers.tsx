...
export default function AdminTeachers() {
  ...
  const fetchTeachers = async () => {
    ...
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/teachers/${semesterId}`);
      ...
      const formatted = data.map((teacher: any, index: number) => ({
        ...
        photo: teacher.Photo
          ? `https://school-portal-backend-new.onrender.com/uploads/teachers/${teacher.Photo}`
          : '',
      }));
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      if (editingId) {
        ...
        res = await fetch(
          `https://school-portal-backend-new.onrender.com/teachers/${oldTeacher.naturalId}/${semesterId}`,
          {
            method: 'PUT',
            body: formData,
          }
        ...
        res = await fetch('https://school-portal-backend-new.onrender.com/teachers', {
          method: 'POST',
          body: formData,
        });
      }
  ...
  const handleDelete = async (teacher: Teacher) => {
    ...
    try {
      const res = await fetch(
        `https://school-portal-backend-new.onrender.com/teachers/${teacher.naturalId}/${semesterId}`,
        { method: 'DELETE' }
      );
