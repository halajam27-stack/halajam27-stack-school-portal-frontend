...
export default function AdminRelations() {
  ...
  const fetchSectionStudents = async () => {
    ...
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/relations/section-students/${semesterId}`);
  ...
  const fetchSubjectTeachers = async () => {
    ...
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/relations/subject-teachers/${semesterId}`);
      const data = await res.json();
  ...
  useEffect(() => {
    ...
    fetch(`https://school-portal-backend-new.onrender.com/relations/sections/${ssClass}/${semesterId}`)
      .then((res) => res.json())
      .then((data) => {
        setSsSections(
          data.map((s: any) => ({
  ...
  useEffect(() => {
    ...
    fetch(`https://school-portal-backend-new.onrender.com/relations/sections/${stClass}/${semesterId}`)
      .then((res) => res.json())
      .then((data) => {
        setStSections(
          data.map((s: any) => ({
    ...
    fetch(`https://school-portal-backend-new.onrender.com/relations/subjects/${stClass}/${semesterId}`)
      .then((res) => res.json())
      .then((data) => {
        setStSubjects(
          data.map((s: any) => ({
  ...
  const handleAddSectionStudent = async () => {
    ...
    try {
      const res = await fetch('https://school-portal-backend-new.onrender.com/relations/section-students', {
        method: 'POST',
  ...
  const handleDeleteSectionStudent = async (item: SectionStudent) => {
    ...
    try {
      const res = await fetch(
        `https://school-portal-backend-new.onrender.com/relations/section-students/${item.sectionId}/${item.studentId}/${semesterId}`,
        { method: 'DELETE' }
      );
  ...
  const handleAddSubjectTeacher = async () => {
    ...
    try {
      const res = await fetch('https://school-portal-backend-new.onrender.com/relations/subject-teachers', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const handleDeleteSubjectTeacher = async (item: SubjectTeacher) => {
    ...
    try {
      const res = await fetch(
        `https://school-portal-backend-new.onrender.com/relations/subject-teachers/${item.sectionId}/${item.subjectId}/${item.teacherId}/${semesterId}`,
        { method: 'DELETE' }
      );
