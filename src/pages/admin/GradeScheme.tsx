...
export default function AdminGradeScheme() {
  ...
  const fetchData = async () => {
    ...
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/grade-scheme/${selectedSemester}`);
  ...
  const handleAdd = async () => {
    ...
    try {
      const res = await fetch("https://school-portal-backend-new.onrender.com/grade-scheme", {
        method: "POST",
        headers: {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/grade-scheme/${editingId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  const handleDelete = async (id: number) => {
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/grade-scheme/${id}`, {
        method: "DELETE"
      });
