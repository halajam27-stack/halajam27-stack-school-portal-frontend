...
export default function AdminSubjects() {
  ...
  const fetchData = async () => {
    ...
    try {
      const resClasses = await fetch(
        `https://school-portal-backend-new.onrender.com/classes?semesterId=${selectedSemester}`
      );
      const dataClasses = await resClasses.json();
      setClasses(dataClasses);

      const resSubjects = await fetch(
        `https://school-portal-backend-new.onrender.com/subjects?semesterId=${selectedSemester}`
      );
  ...
  const handleAdd = async () => {
    ...
    try {
      const res = await fetch('https://school-portal-backend-new.onrender.com/subjects', {
        method: 'POST',
        headers: {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/subjects/${editingId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDelete = async (id: number) => {
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/subjects/${id}`, {
        method: 'DELETE',
      });
