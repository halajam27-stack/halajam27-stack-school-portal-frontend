...
export default function AdminClasses() {
  ...
  const fetchClasses = () => {
    ...
    fetch(`https://school-portal-backend-new.onrender.com/classes?semesterId=${selectedSemester}`)
      .then(res => res.json())
      .then(data => {
  ...
  const handleAdd = async () => {
    ...
    try {
      const res = await fetch("https://school-portal-backend-new.onrender.com/classes", {
        method: "POST",
        headers: {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/classes/${editingId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  const handleDelete = async (id: number) => {
    try {
      const res = await fetch(`https://school-portal-backend-new.onrender.com/classes/${id}`, {
        method: "DELETE"
      });
