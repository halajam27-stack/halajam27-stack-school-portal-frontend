...
export default function StudentSubjects() {
    ...
    const fetchSubjects = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new.onrender.com/student/subjects/${naturalId}/${semesterId}`
        );
  ...
  const handleOpenBook = (bookPath: string | null) => {
    ...
    window.open(`https://school-portal-backend-new.onrender.com${bookPath}`, '_blank');
  };
