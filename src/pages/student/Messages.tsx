...
export default function StudentMessages() {
    ...
    const fetchSubjects = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/student/messages/subjects/${studentId}/${semesterId}`
        );
  ...
  useEffect(() => {
    const fetchUnreadSubjects = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/student/messages/unread-subjects/${studentId}/${semesterId}`
        );
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      ...
      try {
        const res = await fetch(
          `https://school-portal-backend-new-cfr6.onrender.com/student/messages/chat?sectionId=${selectedSubjectData.sectionId}&subjectId=${selectedSubjectData.subjectId}&semesterId=${semesterId}&teacherId=${selectedSubjectData.teacherId}&studentId=${studentId}`
        );
        const data = await res.json();
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const res = await fetch('https://school-portal-backend-new-cfr6.onrender.com/student/messages/send', {
        method: 'POST',
